...
class FloatingDaangnButton extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final folatingButtonState = ref.watch(floatingButtonStateProvider);
    final isExpanded = folatingButtonState.isExpanded;
    final isSmall = folatingButtonState.isSmall;
